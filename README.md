# UnivImGuiHook
Better than UnivHookX, it handle mouse input. Need refine the Console.
...
- Press `TAB` to display the menu, `F11` to uninject by default, you can configure your own keys in `globals.cpp`

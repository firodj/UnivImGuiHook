...
public:
	DI_HID_MouseEvent(): eventTime(0), eventType(type_not_valid) { }
...
public:
	...
	static LRESULT CALLBACK						WndProcDo(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
